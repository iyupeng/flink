...
public interface SupportsAggregatePushDown {
     ...
     *
     * @param groupingSets an array list of the grouping sets. In the example mentioned in {@link
     *     SupportsAggregatePushDown}, this method would receive the groupingSets of {@code List([1,
     *     4])} which is equivalent to {@code List(["name", "type"])}. Currently, this list contains
     *     one array only.
